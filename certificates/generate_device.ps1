...
$rootCert = New-SelfSignedCertificate -DnsName "PS B-Temia" -CertStoreLocation "cert:\LocalMachine\My" -NotAfter (Get-Date).AddYears(20) -FriendlyName "PS B-Temia Root CA" -KeyUsageProperty All -KeyUsage CertSign, CRLSign, DigitalSignature
Write-Host "PS B-Temia Root Cert Thumbprint " + $rootCert.Thumbprint
...
# Keeogo
$keeogoCert = New-SelfSignedCertificate -certstorelocation cert:\localmachine\my -dnsname "PS B-Temia Keeogo" -Signer $rootCert -NotAfter (Get-Date).AddYears(20) -FriendlyName "PS B-Temia Keeogo" -KeyUsageProperty All -KeyUsage CertSign, CRLSign, DigitalSignature -TextExtension @("2.5.29.19={text}CA=1&pathlength=1") 
Write-Host "PS B-Temia Keeogo Cert Thumbprint " + $keeogoCert.Thumbprint
...
cat btemia_root_ca.pem, keeogo.pem > iot.keeogo.pem
...
$keeogQCCert = New-SelfSignedCertificate -certstorelocation cert:\localmachine\my -dnsname "PS B-Temia Keeogo Quebec" -Signer $keeogoCert -NotAfter (Get-Date).AddYears(20) -FriendlyName "PS B-Temia Keeogo Quebec" -KeyUsageProperty All -KeyUsage CertSign, CRLSign, DigitalSignature -TextExtension @("2.5.29.19={text}CA=1&pathlength=1") 
Write-Host "PS B-Temia Keeogo Quebec Cert Thumbprint " + $keeogQCCert.Thumbprint
...
cat btemia_root_ca.pem, keeogo.pem, keeogo-qc.pem > iot.keeogo-qc.pem

# Keeogo 0001 From Keoogo Quebec Factory
$keeogoQC00001Cert = New-SelfSignedCertificate -certstorelocation cert:\localmachine\my -dnsname "PS B-Temia Keeogo Quebec 00001" -Signer $keeogQCCert -NotAfter (Get-Date).AddYears(20) -FriendlyName "PS B-Temia Keeogo Quebec 00001"
Write-Host "PS B-Temia Keeogo Quebec 00001 Cert Thumbprint " + $keeogoQC00001Cert.Thumbprint
...
cat btemia_root_ca.pem, keeogo.pem, keeogo-qc.pem, keeogo-qc-00001.pem > iot.keeogo-qc-00001.pem

# Keeogo 0002 From Keoogo Quebec Factory
$keeogoQC00002Cert = New-SelfSignedCertificate -certstorelocation cert:\localmachine\my -dnsname "PS B-Temia Keeogo Quebec 00002" -Signer $keeogQCCert -NotAfter (Get-Date).AddYears(20) -FriendlyName "PS B-Temia Keeogo Quebec 00002"
Write-Host "PS B-Temia Keeogo Quebec 00002 Cert Thumbprint " + $keeogoQC00002Cert.Thumbprint
...
cat btemia_root_ca.pem, keeogo.pem, keeogo-qc.pem, keeogo-qc-00002.pem > iot.keeogo-qc-00002.pem

# Keoogo Taiwan Intermediate Certificate
$keeogTWCert = New-SelfSignedCertificate -certstorelocation cert:\localmachine\my -dnsname "PS B-Temia Keeogo Taiwan" -Signer $keeogoCert -NotAfter (Get-Date).AddYears(20) -FriendlyName "PS B-Temia Keeogo Taiwan" -KeyUsageProperty All -KeyUsage CertSign, CRLSign, DigitalSignature -TextExtension @("2.5.29.19={text}CA=1&pathlength=1") 
Write-Host "PS B-Temia Keeogo Taiwan Cert Thumbprint " + $keeogTWCert.Thumbprint
...
cat btemia_root_ca.pem, keeogo.pem, keeogo-tw.pem > iot.keeogo-tw.pem

# Keeogo 0001 From Keoogo Taiwan Factory
$keeogoTW00001Cert = New-SelfSignedCertificate -certstorelocation cert:\localmachine\my -dnsname "PS B-Temia Keeogo Taiwan 00001" -Signer $keeogTWCert -NotAfter (Get-Date).AddYears(20) -FriendlyName "PS B-Temia Keeogo Taiwan 00001"
Write-Host "PS B-Temia Keeogo Taiwan 00001 Cert Thumbprint " + $keeogoTW00001Cert.Thumbprint
...
cat btemia_root_ca.pem, keeogo.pem, keeogo-tw.pem, keeogo-tw-00001.pem > iot.keeogo-tw-00001.pem

# Keeogo 0002 From Keoogo Taiwan Factory
$keeogoTW00002Cert = New-SelfSignedCertificate -certstorelocation cert:\localmachine\my -dnsname "PS B-Temia Keeogo Taiwan 00002" -Signer $keeogTWCert -NotAfter (Get-Date).AddYears(20) -FriendlyName "PS B-Temia Keeogo Taiwan 00002"
Write-Host "PS B-Temia Keeogo Taiwan 00002 Cert Thumbprint " + $keeogoTW00002Cert.Thumbprint
...
cat btemia_root_ca.pem, keeogo.pem, keeogo-tw.pem, keeogo-tw-00002.pem > iot.keeogo-tw-00002.pem


# localhost From Root
$localhostCert = New-SelfSignedCertificate -certstorelocation cert:\localmachine\my -dnsname "PS B-Temia Test localhost" -Signer $keeogoCert -NotAfter (Get-Date).AddYears(20) -FriendlyName "PS B-Temia Keeogo localhost"
